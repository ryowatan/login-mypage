...
<body>
        ...
        <main>
                <!--PPPからのコピペするとダブルクォーテーションが(")ではなく(”)になっていることがあるので注意
                ページを読み来ない場合⓵スペルミス⓶XAMPP内にファイルがない⓷同ファイル内に移動先のファイルがない⓸XAMPPのポート80の使用
                ⓹キャッシュのクリア　を行う。-->

                <!--enctype="multipart/form-dataはファイルのアップロードに必要-->
                ...
                <form action="register_confirm.php" method="post" enctype="multipart/form-data">
                        <div class="form_contents">
                                ...
                                <div class="picture">
                                        ...
                                        <!--ファイルのアップロードの場合は、容量の大きさの定義とファイルタグの二種が必要-->
...
<!--http://localhost/register/login_mypage/register.php-->
</html>